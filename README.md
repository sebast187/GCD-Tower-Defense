...
** Since 'dir' folder is not available to to its large size, install pyinstaller with the pip command; then, to make it into an excecutable, change the directory towards the 'main.py' file location, then input this command into the terminal:
